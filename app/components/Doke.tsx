    ...
    <motion.div initial="hidden" animate="visible" variants={dockVariants}>
        <TooltipProvider>
              <Dock direction="middle" className="fixed bottom-5 left-0 right-0 z-50 rounded-full drop-shadow-lg">
                ...
                {Object.values(DATA.toggle)
                .filter((toggle) => toggle.name === 'Light Mode')
                .map((toggle) => (
                  <DockIcon key={toggle.name}>
                    <Tooltip>
                      <TooltipTrigger>
                        <Link href={toggle.url}
                          className={cn(
                            buttonVariants({ variant: "ghost", size: "icon" }),
                            "size-12 rounded-full",
                          )}>
                      ...
                      <TooltipContent>{toggle.name}</TooltipContent>
                    </Tooltip>
                  </DockIcon>
                ))}
              </Dock>
